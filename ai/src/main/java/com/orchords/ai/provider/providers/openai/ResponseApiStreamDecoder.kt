...
import com.orchords.ai.provider.stream.DecodeResult
...
import com.orchords.ai.util.parseErrorDetail
...
internal class ResponseApiStreamDecoder : StreamChunkDecoder {
    ...
    private class ResponseStreamState {
        ...
        fun startServerTool(tool: com.orchords.ai.ui.UIMessagePart.ServerTool): List<StreamChunk> =
