...
private const val TAG = "OrchordsAiActivity"

class OrchordsAiActivity : ComponentActivity() {
    ...
    fun AppRoutes() {
        ...
        LaunchedEffect(tts) {
            eventBus.events.collect { event ->
                when (event) {
                    ...
                    is AppEvent.OpenUsageAccessSettings -> this@OrchordsAiActivity.openUsageAccessSettings()
        ...
        SideEffect { this@OrchordsAiActivity.navStack = backStack }
