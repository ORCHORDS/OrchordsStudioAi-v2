...
interface FavoriteDAO {
    ...
    @Query("SELECT * FROM favorites WHERE type = 'node' AND ref_key LIKE 'node:' || :conversationId || ':%'")
    suspend fun getNodeFavoritesOfConversation(conversationId: String): List<FavoriteEntity>
