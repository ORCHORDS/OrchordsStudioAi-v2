...
import com.orchords.common.http.AcceptLanguageBuilder
import com.orchords.orchordsai.BuildConfig
import com.orchords.orchordsai.data.ai.AIRequestInterceptor
import com.orchords.orchordsai.data.ai.RequestLoggingInterceptor
import com.orchords.orchordsai.data.ai.transformers.AssistantTemplateLoader
...
import com.orchords.orchordsai.data.db.migrations.Migration_6_7
import com.orchords.orchordsai.data.db.migrations.Migration_11_12
            ...
            .addInterceptor { chain ->
                ...
                if (originalRequest.header(HttpHeaders.UserAgent) == null) {
                    val userAgent = settingsStore.settingsFlow.value.networkSetting.userAgent
                        .trim()
                        .ifEmpty { "OrchordsAI-Android/${BuildConfig.VERSION_NAME}" }
