...
import com.orchords.orchordsai.utils.stripMarkdown
...
import com.orchords.tts.controller.TtsController
...
private class CustomTtsStateImpl(
    ...
    private val controller by lazy { com.orchords.tts.controller.TtsController(context, ttsManager) }
