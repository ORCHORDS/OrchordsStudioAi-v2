...
import com.orchords.orchordsai.ui.components.ui.SelectTextField
...
private fun StepTTSConfiguration(
    ...
    FormItem(
        label = { Text(stringResource(R.string.setting_tts_page_api_key)) },
        description = { Text("Get your API key from the StepFun console: platform.stepfun.com/interface-key") }
    ) {
        OutlinedTextField(
            value = setting.apiKey,
            onValueChange = { newApiKey ->
            ...
            modifier = Modifier.fillMaxWidth(),
            placeholder = { Text("Get your API key from the StepFun console") },
        )
    }
    ...
    // Model
    val models = listOf(
        "step-tts-mini" to "step-tts-mini (lightweight, cheap)",
    ...
    val voices = listOf(
        "elegantgentle-female" to "Graceful (elegantgentle-female)",
        "livelybreezy-female" to "Lively Breeze (livelybreezy-female)",
        ...
        "wenroushunv" to "Gentle Mature (wenroushunv)",
        "tianmeinvsheng" to "Sweet Female (tianmeinvsheng)",
        "qingchunshaonv" to "Pure Young (qingchunshaonv)",
        "wenrounvsheng" to "Gentle Female (wenrounvsheng)",
        "ruanmengnvsheng" to "Soft Cute (ruanmengnvsheng)",
        "youyanvsheng" to "Elegant Female (youyanvsheng)",
        "lengyanyujie" to "Cool Queen (lengyanyujie)",
        "shuangkuaijiejie" to "Breezy Sister (shuangkuaijiejie)",
        "wenjingxuejie" to "Quiet Senior (wenjingxuejie)",
        "linjiajiejie" to "Girl-Next-Door Elder (linjiajiejie)",
    ...
    FormItem(
        ...
        description = { Text("Global context instruction, only effective for stepaudio-2.5-tts (≤200 chars, omitted when empty)") }
    ) {
        OutlinedTextField(
