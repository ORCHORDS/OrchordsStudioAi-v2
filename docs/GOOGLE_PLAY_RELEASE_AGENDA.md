...
- Manifest permission declarations were counted from `app/src/main/AndroidManifest.xml` on HEAD `52e3a4e`: **16 lines matching `uses-permission`** (including multiline declarations; exact permission names require final manifest review).
