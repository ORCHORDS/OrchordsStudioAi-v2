package com.orchords.highlight
    ...
    override val values = sequenceOf(
        ...
        HighlightPreviewSample(
            ...
            code = """
                ...
                int main() {
                    const std::string name = "Orchords";
        ...
        HighlightPreviewSample(
            ...
            code = """
                ...
                Console.WriteLine(new User("Orchords").Greet());
            """.trimIndent(),
        ),
        HighlightPreviewSample(
            language = "rust",
            code = """
                ...
                fn main() {
                    let user = User { name: "Orchords".to_string(), age: 18 };
                    println!("Hello, {}!", user.name);
                }
            """.trimIndent(),
        ),
        ...
        HighlightPreviewSample(
            ...
            code = """
                ...
                print(User(name: "Orchords").greet())
            """.trimIndent(),
        ),
        HighlightPreviewSample(
            language = "sql",
        ...
        HighlightPreviewSample(
            ...
            code = """
                ...
                project(orchords LANGUAGES CXX)
                add_executable(orchords main.cpp)
            """.trimIndent(),
        ),
    )
}
