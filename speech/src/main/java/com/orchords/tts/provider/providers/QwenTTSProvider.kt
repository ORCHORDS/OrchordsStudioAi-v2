...
class QwenTTSProvider : TTSProvider<TTSProviderSetting.Qwen> {
    ...
    override fun generateSpeech(
        ...
        require(!providerSetting.model.startsWith("qwen3-tts")) {
            "Legacy Qwen3 TTS models are no longer supported; switch to qwen-audio-3.0-tts-plus or qwen-audio-3.0-tts-flash in TTS settings"
        }
        require(!providerSetting.baseUrl.contains("{WorkspaceId}")) {
            "Replace {WorkspaceId} in the Base URL with your Alibaba Bailian workspace ID"
        }
