/**
 * Display settings
 * @see app/src/main/java/com/orchords/orchordsai/data/datastore/PreferencesStore.kt - DisplaySetting
 */
 ...
 * @see app/src/main/java/com/orchords/orchordsai/data/datastore/PreferencesStore.kt - Settings
 */
